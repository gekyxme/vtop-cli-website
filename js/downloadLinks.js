fetch("../latest.json").then(response => response.json()).then(data => { 
    ...
    windowsAnchorTag.href = `https://github.com/gekyxme/vtop-cli-website/raw/main/buildFiles/v${data.version.windows}/vtop-cli_windows_v${data.version.windows}.zip`;
    linuxAnchorTag.href = `https://github.com/gekyxme/vtop-cli-website/raw/main/buildFiles/v${data.version.linux}/vtop-cli_linux_v${data.version.linux}.zip`;
    macAnchorTag.href = `https://github.com/gekyxme/vtop-cli-website/raw/main/buildFiles/v${data.version.mac}/vtop-cli_mac_v${data.version.mac}.zip`;
